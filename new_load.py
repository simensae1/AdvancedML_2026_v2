...
print(f"Files in {my_bucket}:", fs.ls(my_bucket))

# Download Datasets
datasets = [
    "sim2023/advancedeml/kaggle_traffic_light_data_set.zip",
    "sim2023/advancedeml/pedestrian_Traffic_Light_v1i_yolov11.zip"
]
...
if not os.path.exists(local_model):
    os.makedirs("models", exist_ok=True)
    print(f"Downloading model: {s3_model}")
>>>>>>> 7945e28bc1ab51c55640968705699bc99f8d041f
